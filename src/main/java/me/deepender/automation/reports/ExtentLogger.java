...
import me.deepender.automation.utils.ScreenshotUtils;
...
public final class ExtentLogger {
    ...
    public static void pass(String message, boolean isScreenshotNeeded) throws Exception {
        if (PropertyUtils.getValueFromMap(ConfigProperties.PASSEDSTEPSSCREENSHOTS).equalsIgnoreCase("yes")
                && isScreenshotNeeded) {
    ...
    public static void fail(String message, boolean isScreenshotNeeded) throws Exception {
        if (PropertyUtils.getValueFromMap(ConfigProperties.FAILEDSTEPSSCREENSHOTS).equalsIgnoreCase("yes")
                && isScreenshotNeeded) {
    ...
    public static void skip(String message, boolean isScreenshotNeeded) throws Exception {
        if (PropertyUtils.getValueFromMap(ConfigProperties.SKIPPEDSTEPSSCREENSHOTS).equalsIgnoreCase("yes")
                && isScreenshotNeeded) {
